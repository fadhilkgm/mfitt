...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $monthlySales = Invoice::selectRaw('SUM(total) as total_amount, MONTH(created_at) as month')
        ...
        $topSales = Invoice::join('sales', 'invoices.id', '=', 'sales.invoice_id')->select('sales.product_id', DB::raw('SUM(total) as total_sales'))
            ->groupBy('product_id')
        ...
        $yesterdaySales = Invoice::whereDate('created_at', $yesterday)->sum('total');
