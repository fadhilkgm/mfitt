                    ...
                    <form method="POST" action="{{ route('invoice.update', $invoice->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="date" class="form-control datepicker" value="{{ $invoice->created_at->format('Y-m-d') }}" type="date">
                            </div>
                        </div>
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width: 5%;"><a class="addRow badge badge-success text-white"><i class="fa fa-plus"></i> Add Row</a></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group" style="width: 120px;">
                                            <input type="text" name="qty[]" value="{{ $item->qty }}" class="form-control qty">
                                            <div class="input-group-append">
                                                <span class="input-group-text unit">{{$item->product->unit}}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td><input type="text" name="count[]" value="{{ $item->count }}" class="form-control count" style="width: 80px;"></td>
                                    <td><input type="text" name="price[]" value="{{ $item->price }}" class="form-control price" style="width: 100px;"></td>
                                    <td><input type="text" name="dis[]" value="{{ $item->dis }}" class="form-control dis" style="width: 100px;"></td>
                                    <td><input type="text" name="amount[]" value="{{ $item->amount }}" class="form-control amount" style="width: 100px;"></td>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="4"></td>
                                    <td><b>Total</b></td>
                                    <td><b class="total">{{$invoice->total}}</b></td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
    ...
    $(document).ready(function () {
        ...
        function addRow() {
            var addRow = '<tr>\n' +
                ...
                '    <td><input type="text" name="dis[]" class="form-control dis" style="width: 100px;"></td>\n' +
