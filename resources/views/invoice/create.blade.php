                    ...
                    <form method="POST" action="{{ route('invoice.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="customer_phone" class="form-control" type="text" placeholder="Mobile Number">
                            </div>
                            <div class="form-group col-md-3">
                                <label class="control-label">Date</label>
                                <input name="date" class="form-control datepicker" value="{{ date('Y-m-d') }}" type="date">
                            </div>
                        </div>
