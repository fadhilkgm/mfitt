                    ...
                    <form method="POST" action="{{ route('purchase.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="supplier_phone" id="supplier-phone"
                                    class="form-control @error('supplier_phone') is-invalid @enderror" type="text"
                                    placeholder="Mobile Number" value="{{ old('supplier_phone') }}">
